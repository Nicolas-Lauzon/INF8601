...
//     *image             = (struct rgb*)calloc(width * height, sizeof(struct
//     rgb)); struct rgb* img    = *image; int interval       =
//     get_color_interval((float)height); float interval_inv =
//     get_color_interval_inv((float)height); for (j = 0; j < height; j++) {
//         for (i = 0; i < width; i++) {
